...
ax.grid(False)
surf = ax.plot_surface(X, T, ext, linewidth=0, cmap="cool", antialiased=False, alpha=0.6,rcount=200, ccount=200)
...
# Bonus: To get rid of the grid as well:
ax.grid(False)
surf = ax.plot_surface(X, T, u,  linewidth=0, cmap="cool", antialiased=False, alpha=0.6,rcount=200, ccount=200)
